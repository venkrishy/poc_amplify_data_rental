...
export default function RentalCarModelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new RentalCarModel(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "RentalCarModelCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
